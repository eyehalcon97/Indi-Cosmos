...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Images/telescopioiconoprincipal.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        ScrollPanelPrincipal->setGeometry(QRect(0, 0, 456, 497));
        ...
        PanelDerecho->setMinimumSize(QSize(300, 400));
        ...
        propiedades->setGeometry(QRect(0, 0, 298, 497));
